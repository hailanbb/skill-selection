...
def start_background(
    ...
    command = background_command(source_url, output_path, status_path, yt_dlp)
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Extract safe yt-dlp metadata without nested PowerShell command strings"
    )
    ...
    if args.background:
        ...
        try:
            pid = start_background(args.url, output_path, status_path, log_path, args.yt_dlp)
