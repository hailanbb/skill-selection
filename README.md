...
└── skills/                     # 技能集合目录
    ├── github-tools-collect/    # 普通 GitHub 工具收藏到独立 tools 仓库
...
| **GitHub 工具收藏** | 将普通软件与实用工具整理到独立的 tools 仓库，生成中文指南、来源与版本记录，支持源码快照和去重校验。 | 收藏 GitHub 工具到 tools、更新已有工具、检查收藏库。 | [👉 安装与使用指南](skills/github-tools-collect/README.md) |
