...
按销售小组名单人数、客户类型权重和步行距离，均衡分配香港公益义诊活动附近客户。诊所类客户权重为其他客户的 1.5 倍；先预览确认，随后生成包含“分配总览”“客户分工”“小组路线建议”“待核实资料”四个页签的 Excel。

适用场景：香港 18 区商场、写字楼、广场等为期 15–30 天的公益义诊活动客户分工与步行路线规划。

[👉 详细配置与使用指南](skills/hk-event-customer-allocation/README.md)
